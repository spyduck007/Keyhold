...
class UsbKeyAnimation(QWidget):
    ...
    def paintEvent(self, event: object) -> None:
        ...
        painter.setPen(QPen(QColor("#d7d7d7"), 3.5, Qt.PenStyle.SolidLine, Qt.PenCapStyle.RoundCap))
        ...
        painter.setPen(QPen(QColor("#262626"), 3, Qt.PenStyle.SolidLine, Qt.PenCapStyle.RoundCap))
        painter.drawLine(-8, -33, -8, -20)
        painter.drawLine(8, -33, 8, -20)
        painter.setPen(QPen(QColor("#dddddd"), 3, Qt.PenStyle.SolidLine, Qt.PenCapStyle.RoundCap))
